...
- **EVM**: SP1 sovereign cells. Pyana STARKs wrapped in Groth16 for on-chain verification (~200k gas). VK governance for upgrade safety. Deposit/withdraw cycle.
