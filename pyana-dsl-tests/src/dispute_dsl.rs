...
pub fn dispute_circuit_descriptor() -> CircuitDescriptor {
    ...
    CircuitDescriptor {
        name: "pyana-dispute-state-machine-v1".into(),
...
mod tests {
    ...
    fn descriptor_has_correct_structure() {
        ...
        assert_eq!(desc.name, "pyana-dispute-state-machine-v1");
    ...
    fn deploys_as_cell_program() {
        use pyana_dsl_runtime::circuit::CellProgram;
        use pyana_dsl_runtime::circuit::ProgramRegistry;
