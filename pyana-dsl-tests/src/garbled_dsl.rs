...
pub struct ExtendedGateRecord {
    ...
    pub base: pyana_circuit::garbled::GateEvalRecord,
...
mod tests {
    ...
    fn extended_descriptor_has_correct_structure() {
        ...
        assert_eq!(desc.public_input_count, 8);
        assert_eq!(desc.name, "pyana-garbled-evaluation-extended-dsl-v1");
    ...
    fn extended_different_gate_types_in_one_circuit() {
        ...
        fn make_record(
            ...
            gate_idx: u32,
            output: [BabyBear; 8],
        ) -> pyana_circuit::garbled::GateEvalRecord {
        ...
        let commitment =
            pyana_circuit::binding::WideHash::from_poseidon2("test-circuit", &[BabyBear::new(42)]);
    ...
    fn extended_fan_out_wire_used_twice() {
        ...
        let commitment =
            pyana_circuit::binding::WideHash::from_poseidon2("fan-out-test", &[BabyBear::new(77)]);
    ...
    fn extended_wrong_gate_output_caught() {
        ...
        let commitment =
            pyana_circuit::binding::WideHash::from_poseidon2("tamper-test", &[BabyBear::new(42)]);
    ...
    fn extended_wrong_chain_caught() {
        ...
        let commitment = pyana_circuit::binding::WideHash::from_poseidon2(
            "chain-break-test",
            &[BabyBear::new(55)],
        );
    ...
    fn extended_wrong_topological_order_caught() {
        ...
        let bad_record = ExtendedGateRecord {
            base: pyana_circuit::garbled::GateEvalRecord {
                left_label: label_a,
                right_label: label_b,
        ...
        let commitment =
            pyana_circuit::binding::WideHash::from_poseidon2("topo-test", &[BabyBear::new(33)]);
    ...
    fn extended_stark_prove_verify_synthetic_4_gates() {
        ...
        let commitment =
            pyana_circuit::binding::WideHash::from_poseidon2("4-gate-test", &[BabyBear::new(123)]);
        let output_hash = garbled::hash_label(&label_b);
