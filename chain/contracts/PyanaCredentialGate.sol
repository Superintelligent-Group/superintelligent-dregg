...
import "./IPyanaCredentialGate.sol";

/// @title PyanaCredentialGate
/// @notice Verifies pyana anonymous credentials on-chain and gates actions (NFT mints, votes).
///
...
contract PyanaCredentialGate is IPyanaCredentialGate {
    // ─── Immutables ─────────────────────────────────────────────────────────

    /// Address of the SP1 Verifier Gateway contract.
    address public immutable sp1Verifier;

    /// Verification key identifying the pyana credential verifier guest program.
    ...
    /// @param _programVkey Verification key for the pyana credential verifier program.
    ...
    /// @inheritdoc IPyanaCredentialGate
