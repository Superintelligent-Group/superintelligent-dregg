...
/// @title IPyanaCredentialGate
/// @notice Verifies pyana anonymous credentials on-chain without learning the presenter's identity.
///
...
interface IPyanaCredentialGate {
    ...
    /// @notice Verify a pyana anonymous credential without learning the presenter's identity.
    ...
    ///        - Program vkey identifying the pyana credential verifier program
    ///
