...
impl BridgeActionAir {
    ...
    pub fn generate_trace(witness: &BridgeActionWitness) -> (Vec<Vec<BabyBear>>, Vec<BabyBear>) {
        ...
        row0[col::NULLIFIER_START..col::NULLIFIER_START + HASH_LIMBS]
            .copy_from_slice(&n[..HASH_LIMBS]);
        row0[col::RECIPIENT_START..col::RECIPIENT_START + HASH_LIMBS]
            .copy_from_slice(&r[..HASH_LIMBS]);
        row0[col::DESTINATION_FEDERATION_START..col::DESTINATION_FEDERATION_START + HASH_LIMBS]
            .copy_from_slice(&d[..HASH_LIMBS]);
