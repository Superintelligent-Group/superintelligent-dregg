...
//! to `dregg_cell::program::StateConstraint`. The migration finishes
...
//! ## What this replaces
//!
//! - `dregg_storage::programmable::{QueueProgram, QueueConstraint,
...
//! - `dregg_storage::programmable::QueueFactory` — subsumed by
//!   [`FactoryDescriptor`].
...
pub const PROGRAMMABLE_QUEUE_FACTORY_VK: [u8; 32] = *b"dregg-storage-tpl-pqueue-factory";
...
pub fn register(ctx: &StarbridgeAppContext) -> [u8; 32] {
    ...
    ctx.register_inspector(InspectorDescriptor {
        ...
        descriptor: serde_json::json!({
            "component": "dregg-programmable-queue",
            "module": "/dregg-storage-templates/programmable-queue.js",
...
mod tests {
    ...
    fn descriptor_validates_against_canonical_program() {
        ...
        dregg_app_framework::validate_child_vk_canonical(&d, &programmable_queue_program())
