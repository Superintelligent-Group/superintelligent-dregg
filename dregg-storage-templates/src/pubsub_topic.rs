...
//! ## What this replaces
//!
//! - `dregg_storage::pubsub::PubSubTopic` operator-process state.
//! - `dregg_storage::dedup::DeduplicationFilter` — folds into slot 7's
...
pub const PUBSUB_TOPIC_FACTORY_VK: [u8; 32] = *b"dregg-storage-tpl-pubsub-factory";
...
pub fn register(ctx: &StarbridgeAppContext) -> [u8; 32] {
    ...
    ctx.register_inspector(InspectorDescriptor {
        ...
        descriptor: serde_json::json!({
            "component": "dregg-pubsub-topic",
            "module": "/dregg-storage-templates/pubsub-topic.js",
...
mod tests {
    ...
    fn descriptor_validates_against_canonical_program() {
        ...
        dregg_app_framework::validate_child_vk_canonical(&d, &pubsub_topic_program())
