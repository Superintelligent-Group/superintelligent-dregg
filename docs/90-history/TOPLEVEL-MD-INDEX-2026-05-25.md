# TOPLEVEL-MD-INDEX — workspace-root markdown index

> Current docs front door: [`docs/README.md`](../README.md).
> This file remains an index of root-level Markdown artifacts, but new
> canonical navigation should live under `docs/`.
